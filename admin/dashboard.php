...
<body>
	...
	<h2>Admin Links</h2>
	<ul>
		<li><a href="announcements/manage.php">Manage Announcements</a></li>
		<li><a href="announcements/add.php">Add Announcement</a></li>
		<li><a href="feedback/view.php">View Feedback</a></li>
