            ...
            <?php else: ?>
                <?php foreach ($announcements as $announcement): ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_announcement.php?id=<?= $announcement['AnnouncementID'] ?>">Edit</a>
                            <a href="delete_announcement.php?id=<?= $announcement['AnnouncementID'] ?>" onclick="return confirm('Are you sure?');">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
